        ...
        renderItem={({ item }) => (
          <View>
            ...
            <Card style={styles.card}>
              ...
              <Text>
                <Text style={styles.cardText}>Tipo de maker: </Text>
                <Text style={styles.textApi}>{item.type}</Text>
              </Text>
            </Card>
            <Card style={styles.card}>
              <Text>
...
export default ListAllFrevoMakers;
